 ...
 * review runs; these act on the PR's GitHub state. gh policy errors (e.g.
 * self-approval) surface inline rather than being pre-gated.
 */
export function PrControls({ pr, repoRoot }: Props) {
  ...
  return (
    <div class="review-pr-controls">
      ...
      {pr.url ? (
        <a class="btn btn-ghost btn-sm" href={pr.url} target="_blank" rel="noreferrer">
          Open on GitHub ↗
        </a>
      ) : null}
